from conta import Conta, Cliente # Aqui importamos as classes "Conta" e "Cliente" do arquivo "conta.py"
...
conta = Conta('123-4', 'João', 120.0, 1000.0) # Criamos o objeto com os atributos
print(conta.numero) # imprimimos o número da conta
print(conta.titular) # imprimimos o titular da conta
conta1=Conta("444-4", "Anderson", 500, 2000) # Criei a conta 1
conta2=Conta("222-2", "Inácio", 1000, 3000) # Criei a conta 2
